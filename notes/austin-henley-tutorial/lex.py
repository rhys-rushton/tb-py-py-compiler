...
class Lexer:
    def __init__(self, source):
        # Source code to lex as a string. Append a newline to simplify lexing/parsing the 
        # last token/statement.
        self.source = source + '\n'
    ...
    def getToken(self):
        ...
        if self.curChar == '+':
            ...
            if self.peek() == '=':
                ...
                # curchar then gets set to nextChar below
                # remember the true condition here is .peek 
                self.nextChar()
